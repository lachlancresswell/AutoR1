...
describe('getAllAsObjects', () => {
	it('should return an array of objects', () => {
		...
		step.mockReturnValueOnce(true).mockReturnValueOnce(true).mockReturnValueOnce(false);
		getAsObject.mockReturnValueOnce(array[0]).mockReturnValueOnce(array[1]);
...
describe('ProjectFile', () => {
	...
	describe('getMasterGroupID', () => {
		it('should return the master group id', async () => {
			// Arrange
			const GroupId = 1;
			getAsObject.mockReturnValueOnce({ GroupId }).mockReturnValueOnce({ GroupId });
		...
		it('should log an error if the master group is not found', async () => {
			// Arrange
			getAsObject.mockReturnValueOnce({ GroupId: undefined });
	...
	describe('getSourceGroupNameFromID', () => {
		...
		it('should return undefined if the source group is not found', async () => {
			// Arrange
			getAsObject.mockReturnValueOnce({ Name: undefined });
	...
	describe('getSourceGroupIDFromName', () => {
		it('should return the source group ID from the name', async () => {
			...
			getAsObject.mockReturnValueOnce({ SourceGroupId });
	...
	describe('getHighestJoinedID', () => {
		it('should return a JoinedId', async () => {
			// Arrange
			const JoinedId = 2;
			getAsObject.mockReturnValueOnce({ JoinedId });
	...
	describe('getHighestGroupID', () => {
		it('should return a JoinedId', async () => {
			// Arrange
			const GroupId = 2;
			getAsObject.mockReturnValueOnce({ 'max(GroupId)': GroupId });
		...
		it('should return undefined if a JoinedId is not found', async () => {
			...
			getAsObject.mockReturnValueOnce({ JoinedId: GroupId });
	...
	describe('getViewIdFromName', () => {
		it('should return a ViewId', async () => {
			// Arrange
			const ViewId = 3;
			getAsObject.mockReturnValueOnce({ ViewId });
	...
	describe('getCanIdFromDeviceId', () => {
		it('should return a CanId with a prepended 0', async () => {
			...
			getAsObject.mockReturnValueOnce({ RemoteIdSubnet, RemoteIdDevice });
	...
	describe('addChannelToGroup', () => {
		...
		it('should insert group into database with specified options', async () => {
			...
			// Act
			projectFile.addChannelToGroup(groupObj as never);
