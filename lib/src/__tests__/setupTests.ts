...
const PROJECT_NO_INIT_START = './lib/Projects/test_no_init.dbpr';
const PROJECT_INIT_START = './lib/Projects/test_init.dbpr';
const PROJECT_INIT_AP_START = './lib/Projects/test_init_AP.dbpr';
const TEMPLATES_START = './lib/Projects/templates.r2t';
const PROJECT_SUB_ARRAY_START = './lib/Projects/sub_array.dbpr';
